# SupportAI — Example ShepLang Program

This is a complete ShepLang program demonstrating the `ai` primitive for building an AI-powered customer support system.

## What This Demonstrates

- **`data`** — Data models with AI-derived fields
- **`view`** — UI component definitions
- **`action`** — Business logic with AI conditions
- **`ai`** — The AI primitive as a language feature

## Generated Output

The ShepLang compiler generates:

### Backend (ShepThon → Python)

- `generated/main.py` — FastAPI entry point
- `generated/routes.py` — API routes
- `generated/models.py` — Pydantic models
- `generated/ai_client.py` — LLM integration

### Frontend (ShepLang-JS → TypeScript)

- `generated/types.ts` — TypeScript interfaces
- `generated/api.ts` — API client
- `generated/hooks.ts` — React hooks

### Database (ShepSQL → PostgreSQL)
